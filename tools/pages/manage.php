...
?>
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  class="data-tbl">
    <tr class="t-hdr">
      ...
      <td width="20%" align="center"><?=$adm->orders('Page Name',true)?></td>   
	  <td width="15%" align="center"><?=$adm->orders('Page Description',true)?></td>   
    ...
    <td align="center"><?=$page_name?></td>
    <td align="center"><?=$page_description?></td>
