...
$crpw= $getImageSiteDetail[0];
$crph= $getImageSiteDetail[1];
$n= $getImageSiteDetail[4];
					 
$upload_dir = UP_FILES_FS_PATH."/big"; 	
$small = UP_FILES_FS_PATH."/orginal/"; 			// The directory for the images to be saved in
...
<body>	
 <div class="div-tbl">
		...
		<img src="<?=SITE_PATH."uploaded_files/big/".$imageMain;?>" alt="test image" id="testImage"   />
	</div>
       <div class="cl"></div>
