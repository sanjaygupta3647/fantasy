...
<?php 
if($cms->is_post_back()){
	$cms->sqlquery("rs","testimonials",$_POST,'id',1);
	$adm->sessset('Record has been updated', 's');
	$cms->redir(SITE_PATH_ADM."testimonials.php", true);
}
$rsAdmin=$cms->db_query("SELECT * FROM #_testimonials WHERE id='1'");
...
<?php include_once "inc/header.inc.php"; ?>
 <div class="main">
   <header>
    ...
    <div class="content"> 
    <?php $hedtitle = "Dashboard &rsaquo; Testimonials"; ?>  
    ...
    <div class="internal-box"><?=$adm->alert()?>
      ...
      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="frm-tbl2">
        <tr class="grey">
			<td width="18%" align="left" valign="middle">Testimonials Details:*</td>
			<td>
				<?=$adm->get_editor('testimonials',stripslashes($testimonials))?>
			</td>
		</tr>
		<tr class="grey">
