...
<?php 
	...
	$columns = "select * ";
	$sql = " from #_matches where series_id = '$series_id' ";
...
?>
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  class="data-tbl">
    <tr class="t-hdr">
	  ...
	  <td width="25%" align="center"><?=$adm->orders('Series',true)?></td>
	  <td width="25%" align="center"><?=$adm->orders('Time',true)?></td>   
