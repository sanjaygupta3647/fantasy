        ...
        <div class="row">
            <div class="col-md-3 col-sm-6">
                <div class="content-box box-default animated fadeInUp animation-delay-10">
                    <span class="icon-ar icon-ar-lg icon-ar-round icon-ar-inverse"><img src="<?=SITE_PATH?>images/box_icon.png"></span>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="content-box box-default animated fadeInUp animation-delay-14">
                   <span class="icon-ar icon-ar-lg icon-ar-round icon-ar-inverse"><img src="<?=SITE_PATH?>images/box_icon2.png"></span>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="content-box box-default animated fadeInUp animation-delay-16">
                   <span class="icon-ar icon-ar-lg icon-ar-round icon-ar-inverse"><img src="<?=SITE_PATH?>images/box_icon3.png"></span>
   ...
   <p class="grap">Grab your GIfts</p>
       ...
       <li class="bx-clone" style="float: left; list-style: outside none none; position: relative; width: 100px; margin-right: 10px;">
            <div class="img-caption-ar">
                <img src="<?=SITE_PATH?>images/one_slids.jpg" class="img-responsive" alt="Image">
            </div>
...
<div class="box_1">
<p>
<span style="float: left;"><img src="<?=SITE_PATH?>images/face.jpg"></span>
<span style="float: left; padding-left: 12px;"><strong>AB DE VILLIERS </strong><br>
<img src="<?=SITE_PATH?>images/logo1.jpg"> <img src="<?=SITE_PATH?>images/logo1.jpg"></span>
